...
coefficient = [0;0.01;1;2;100;300]; %[0;0.001;0.003;0.006;0.009;0.01]; %
...
function Cdot = matcal_system(t,y,coefficient)
    ...
    k8=1.11;
    k9=coefficient*1.032*5.9959e-3 * 0.7;% 5.78/(va*2e-3); % nconsumption
    k10=0;
    ...
    eq2 = (1/vg)*( k3*vr*y(1) - k4*vg*y(2) - k5*vg*y(2) + k6*ve*y(3) - k7*vg*y(2) + k10*va*y(4) );
